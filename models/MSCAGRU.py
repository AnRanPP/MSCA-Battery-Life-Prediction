# 保存为 F:\LXP\Project\PythonProject\BatteryLife\models\MSCAGRU.py
...
class Model(nn.Module):
    """MSCA-GRU模型 - 使用MSCA插件替代CyclePatch"""
    ...
    def forward(self, cycle_curve_data, curve_attn_mask, return_embedding=False):
        ...
        # Inter-cycle processing with GRU
        packed_output, h_n = self.inter_GRU(packed_input)
