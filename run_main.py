...
from models import CPGRU, CPLSTM, CPMLP, CPBiGRU, CPBiLSTM, CPTransformer, PatchTST, iTransformer, Transformer, \
    ...
    BiLSTM, BiGRU, GRU, LSTM, PCE, PCE_v2
# import wandb
...
def main():
    ...
    for ii in range(args.itr):
        ...
        for epoch in range(args.train_epochs):
            ...
            accelerator.print(
                f"Epoch: {epoch+1} | Train Loss: {train_loss:.5f} | Train RMSE: {train_rmse:.7f} | Train MAPE: {train_mape:.7f} | Vali RMSE: {vali_rmse:.7f} | Vali MAE: {vali_mae_loss:.7f} | Vali MAPE: {vali_mape:.7f} | "
